    ...
    <Container>
      <PersonalInfo>
        ...
        <AboutDetails>
          ...
          in 2013, I embarked on a career in software development, leveraging my
          strong analytical background to excel in this field. Over the past
          four years, I’ve been a software developer for the federal government,
          where I’ve successfully managed and executed a variety of projects,
          optimizing systems and developing innovative solutions. My experience
          has honed my technical skills and deepened my understanding of complex
          systems, making me adept at problem-solving and adapting to new
          challenges. As I look to the next phase of my career, I am eager to
        ...
        <AboutDetails>
          ...
          well-rounded personality. My passion for film fuels my creativity and
          attention to detail, qualities that translate seamlessly into my tech
          work. I enjoy camping, which not only provides a refreshing break from
          the screen but also enhances my problem-solving skills in real-world
          scenarios. Craft beer tasting is a hobby that sharpens my appreciation
          for quality and innovation, while poker sharpens my strategic thinking
          and decision-making abilities. Cycling keeps me energized and
